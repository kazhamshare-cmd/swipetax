...
import { signInWithEmail, signInWithGoogle, signInWithApple, signInWithLine } from '@/lib/auth';
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-orange-400 to-orange-500 p-8 text-center text-white">
                        ...
                        <p className="text-orange-100 text-sm">登録済みの方はこちらから</p>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <Link
                            href="/auth/signup"
                            className="block w-full py-3 border-2 border-orange-500 text-orange-500 font-bold rounded-lg text-center hover:bg-orange-50 transition"
                        >
                            新規アカウント登録（14日間無料）
                        </Link>
